            ...
            <div class="row">
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputUser1" placeholder="Enter Username"> </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputCPassword1">Password</label>
                                        <input type="password" class="form-control" id="exampleInputCPassword1" placeholder="Confirm Password"> </div>
                                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="white-box">
                        ...
                        <form class="form-horizontal">
                            <div class="form-group">
                                <label for="inputUser3" class="col-sm-3 control-label">Username*</label>
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" id="inputUser3" placeholder="Username"> </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="inputWeb3" class="col-sm-3 control-label">Website</label>
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" id="inputWeb3" placeholder="Website"> </div>
                            </div>
                            <div class="form-group">
