(function ($) {
  ...
  var $fixture
  var $table
  var setup = function (tableAttributes) {
    return function () {
  ...
  test('Navigate with buttons', function () {
    var $buttons = $table.prev().find('.tablesaw-nav-btn')
    var $prev = $buttons.filter('.left')
    var $next = $buttons.filter('.right')
  ...
  test('Can sort descending', function () {
    ...
    var $sortButton = $table.find('.tablesaw-sortable-head button').eq(0)
