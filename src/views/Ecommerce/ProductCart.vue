            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-5">
                    <div class="white-box">
                        ...
                        <hr>
                        <small>If you have any discount vouchers/coupans, apply here. If you don't have any, click <a href="javascript:void(0);" class="text-link">here</a> to get one.</small>
                ...
                <div class="col-md-4 col-sm-5">
                    <div class="white-box">
                        ...
                        <hr>
                        <h4><i class="ti-mobile"></i> +1234567890 (Toll Free)</h4> <small>Contact us for any queries. We are avalible 24x7x365.</small>
                    </div>
                </div>
            </div>
            <!--row -->
