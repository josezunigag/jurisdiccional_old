...
jvm.VMLPathElement.pathSvgToVml = function (path) {
  var cx = 0; var cy = 0; var ctrlx; var ctrly
...
jvm.Legend.prototype.render = function () {
  ...
  var i
  var inner = jvm.$('<div/>').addClass('jvectormap-legend-inner')
  var tick
  var sample
  var label
...
jvm.Proj = {
  ...
  aea: function (lat, lng, c) {
    ...
    var ro = Math.sqrt(C - 2 * n * Math.sin(fi)) / n
    var ro0 = Math.sqrt(C - 2 * n * Math.sin(fi0)) / n
  ...
  lcc: function (lat, lng, c) {
    ...
    var ro = F * Math.pow(1 / Math.tan(Math.PI / 4 + fi / 2), n)
    var ro0 = F * Math.pow(1 / Math.tan(Math.PI / 4 + fi0 / 2), n)
...
jvm.Map.prototype = {
  ...
  bindContainerEvents: function () {
    ...
    if (this.params.zoomOnScroll) {
      this.container.mousewheel(function (event, delta, deltaX, deltaY) {
        ...
        var zoomStep = Math.pow(1 + map.params.zoomOnScrollSpeed / 1000, event.deltaFactor * event.deltaY)
  ...
  bindElementEvents: function () {
    ...
    this.container.delegate("[class~='jvectormap-element']", 'mouseover mouseout', function (e) {
      ...
      var tipText = type == 'region' ? map.mapData.paths[code].name : (map.markers[code].config.name || '')
      var tipShowEvent = jvm.$.Event(type + 'TipShow.jvectormap')
      var overEvent = jvm.$.Event(type + 'Over.jvectormap')
    ...
    this.container.delegate("[class~='jvectormap-element']", 'mouseup', function () {
      ...
      var type = baseVal.indexOf('jvectormap-region') === -1 ? 'marker' : 'region'
      var code = type == 'region' ? jvm.$(this).attr('data-code') : jvm.$(this).attr('data-index')
      var clickEvent = jvm.$.Event(type + 'Click.jvectormap')
      var element = type == 'region' ? map.regions[code].element : map.markers[code].element
  ...
  createTip: function () {
    ...
    this.container.mousemove(function (e) {
      ...
      var top = e.pageY - 15 - map.tipHeight
  ...
  setScale: function (scale, anchorX, anchorY, isCentered, animate) {
    ...
    var that = this
    var i = 0
    var count = Math.abs(Math.round((scale - this.scale) * 60 / Math.max(scale, this.scale)))
    var scaleStart
    var scaleDiff
    var transXStart
    var transXDiff
...
jvm.MultiMap.prototype = {
  ...
  drillDown: function (name, code) {
    ...
    var downloadPromise = this.downloadMap(code)
  ...
  goBack: function () {
    ...
    var prevMap = this.history[this.history.length - 1]
    var that = this
