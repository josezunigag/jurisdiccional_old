...
(function (window, document, $, Color, undefined) {
  ...
  AsColorInput.prototype = {
    ...
    position: function () {
      ...
      var picker_width = this.$dropdown.outerWidth(true)
      var picker_height = this.$dropdown.outerHeight(true)
      var top; var left
...
(function ($) {
  ...
  $.asColorPicker.registerComponent('palettes', function () {
    return {
      ...
      init: function (api, options) {
        var self = this
        var colors; var asColor = new $.asColor()
