...
$(function () {
  $('[data-toggle-visible]').each(function () {
    var $element = $(this)
    var $target = $($element.data('toggleVisible'))
  ...
  $('[data-sticky]').each(function () {
    ...
    var margin = $element.data('sticky') || 0
  ...
  $('[data-example]').each(function () {
    var $element = $(this)
    var code = window.atob($element.data('example'))
  ...
  $('[data-live-example]').each(function () {
    ...
    var initialCode = window.atob($element.data('liveExample'))
    var chartist
    var cm
