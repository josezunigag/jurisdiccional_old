...
var Zepto = (function () {
  var undefined; var key; var $; var classList; var emptyArray = []; var slice = emptyArray.slice; var filter = emptyArray.filter
  ...
  zepto.fragment = function (html, name, properties) {
    ...
    var nodes; var dom; var container = containers[name]
  ...
  $.fn = {
    ...
    closest: function (selector, context) {
      var node = this[0]; var collection = false
...
;(function ($) {
  var $$ = $.zepto.qsa; var handlers = {}; var _zid = 1; var specialEvents = {}
...
;(function ($) {
  ...
  $.ajax = function (options) {
    ...
    var xhr = settings.xhr(); var abortTimeout
...
;(function ($, undefined) {
  var prefix = ''; var eventPrefix; var endEventName; var endAnimationName
  var vendors = { Webkit: 'webkit', Moz: '', O: 'o', ms: 'MS' }
  var document = window.document; var testEl = document.createElement('div')
  var supportedTransforms = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i
  var transform
  var transitionProperty; var transitionDuration; var transitionTiming
  var animationName; var animationDuration; var animationTiming
  var cssReset = {}
