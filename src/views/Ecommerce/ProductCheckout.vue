            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="white-box">
                        ...
                        <h2>**** **** **** 2150</h2> <span class="pull-right">Expiry date: 10/16</span> <span class="font-500">Jon Doe</span> </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="white-box">
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="white-box">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-500">$3060</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="font-500" align="right">Coupan Discount</td>
                                        <td class="font-500">$300</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="font-500" align="right">Delivery Charges</td>
                                        <td class="font-500">$150</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="font-500" align="right">Tax</td>
                                        <td class="font-500">$100</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="font-bold text-dark" align="right">Payable Amount</td>
                                        <td class="font-bold text-dark">$3010</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#iprofile" aria-controls="profile" role="tab" data-toggle="tab" aria-expanded="false"><span><i class="fa fa-credit-card"></i></span> Debit Card</a></li>
