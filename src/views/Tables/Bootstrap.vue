            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="white-box">
                        ...
                        <table data-toggle="table" data-url="/data/bootstrap-test.json" data-click-to-select="true" data-select-item-name="myRadioName" data-height="295">
                            <thead>
                                <tr>
                ...
                <div class="col-sm-6">
                    <div class="white-box">
                        ...
                        <table data-toggle="table" data-url="/data/bootstrap-test.json" data-click-to-select="true" data-height="295">
                            <thead>
                                <tr>
