...
/* jshint eqeqeq:false curly:false latedef:false */
  ...
  function setup ($) {
    ...
    function install (el, opts) {
      ...
      var layers = [lyr1, lyr2, lyr3]; var $par = full ? $('body') : $(el)
      ...
      if (ie6 || expr) {
        ...
        if ((ie6 || !$.support.boxModel) && !full) {
          var t = sz(el, 'borderTopWidth'); var l = sz(el, 'borderLeftWidth')
          var fixT = t ? '(0 - ' + t + ')' : 0
          var fixL = l ? '(0 - ' + l + ')' : 0
        }
    ...
    function reset (els, data, opts, el) {
      ...
      var body = $(document.body); var w = body.width(); var cssW = body[0].style.width
    ...
    function center (el, x, y) {
      var p = el.parentNode; var s = el.style
