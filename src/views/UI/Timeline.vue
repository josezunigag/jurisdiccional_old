            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <ul class="timeline">
                            <li>
                                <div class="timeline-badge success"><img class="img-responsive" alt="user" src="../../plugins/images/users/1.jpg"> </div>
                            ...
                            <li class="timeline-inverted">
                                <div class="timeline-badge warning"><img class="img-responsive" alt="user" src="../../plugins/images/users/3.jpg"> </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
