(function (global, factory) {
  ...
  function configFromISO (config) {
    ...
    var match = from_string__isoRegex.exec(string)
  ...
  function dayOfYearFromWeeks (year, week, weekday, firstDayOfWeekOfYear, firstDayOfWeek) {
    var week1Jan = 6 + firstDayOfWeek - firstDayOfWeekOfYear; var janX = createUTCDate(year, 0, 1 + week1Jan); var d = janX.getUTCDay(); var dayOfYear
    if (d < firstDayOfWeek) {
      d += 7
    }
  ...
  function diff (input, units, asFloat) {
    ...
    var zoneDelta = (that.utcOffset() - this.utcOffset()) * 6e4
    var delta; var output
  ...
  function be__weekdaysCaseReplace (m, format) {
    ...
    var nounCase = (/\[ ?[Вв] ?(?:мінулую|наступную)? ?\] ?dddd/).test(format)
      ? 'accusative'
      : 'nominative'
  ...
  var cs__monthsShort = 'led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro'.split('_')
  ...
  var es__monthsShort = 'Ene_Feb_Mar_Abr_May_Jun_Jul_Ago_Sep_Oct_Nov_Dic'.split('_')
  ...
  var fy__monthsShortWithoutDots = 'jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des'.split('_')
  ...
  function ka__monthsCaseReplace (m, format) {
    ...
    var nounCase = (/D[oD] *MMMM?/).test(format)
      ? 'accusative'
      : 'nominative'
    return months[nounCase][m.month()]
  }
  function ka__weekdaysCaseReplace (m, format) {
    ...
    var nounCase = (/(წინა|შემდეგ)/).test(format)
      ? 'accusative'
      : 'nominative'
    return weekdays[nounCase][m.day()]
  }
  ...
  var weekDays = 'sekmadienis_pirmadienis_antradienis_trečiadienis_ketvirtadienis_penktadienis_šeštadienis'.split('_')
  ...
  var nl__monthsShortWithoutDots = 'jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec'.split('_')
  ...
  var sk__monthsShort = 'jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec'.split('_')
