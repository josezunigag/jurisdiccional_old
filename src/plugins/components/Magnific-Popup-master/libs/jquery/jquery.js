 ...
 */
  ...
  jQuery.support = (function () {
    var support; var all; var a; var select; var opt; var input; var fragment; var eventName; var isSupported; var i
  ...
  jQuery.fn.extend({
    ...
    val: function (value) {
      var hooks; var ret; var isFunction
      var elem = this[0]
 ...
 */
  jQuery.event = {
    ...
    add: function (elem, types, handler, data, selector) {
      ...
      var elemData = elem.nodeType !== 3 && elem.nodeType !== 8 && jQuery._data(elem)
    ...
    trigger: function (event, data, elem, onlyHandlers) {
      var i; var cur; var tmp; var bubbleType; var ontype; var handle; var special
      var eventPath = [ elem || document ]
      var type = event.type || event
      var namespaces = event.namespace ? event.namespace.split('.') : []
    ...
    dispatch: function (event) {
      ...
      var i; var j; var ret; var matched; var handleObj
      var handlerQueue = []
    ...
    handlers: function (event, handlers) {
      var i; var matches; var sel; var handleObj
      var handlerQueue = []
 ...
 */
    ...
    function matcherFromGroupMatchers (elementMatchers, setMatchers) {
      ...
      var superMatcher = function (seed, context, xml, results, expandContext) {
        ...
        var dirrunsUnique = (dirruns += contextBackup == null ? 1 : Math.E)
  ...
  function getAll (context, tag) {
    var elems; var elem
    var i = 0
    var found = typeof context.getElementsByTagName !== 'undefined' ? context.getElementsByTagName(tag || '*')
  ...
  jQuery.extend({
    clone: function (elem, dataAndEvents, deepDataAndEvents) {
      var destElements; var srcElements; var node; var i; var clone
    ...
    buildFragment: function (elems, context, scripts, selection) {
      var contains; var elem; var tag; var tmp; var wrap; var tbody; var j
      var l = elems.length
    ...
    cleanData: function (elems, /* internal */ acceptData) {
      var data; var id; var elem; var type
      var i = 0
      var internalKey = jQuery.expando
  ...
  var curCSS; var getStyles; var iframe
  var ralpha = /alpha\([^)]*\)/i
 ...
 */
  ...
  function ajaxConvert (s, response) {
    var conv; var conv2; var current; var tmp
    var converters = {}
    var i = 0
  ...
  function defaultPrefilter (elem, props, opts) {
    ...
    var index; var prop; var value; var length; var dataShow; var toggle; var tween; var hooks; var oldfire
    var anim = this
    var style = elem.style
    var orig = {}
    var handled = []
