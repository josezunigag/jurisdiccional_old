                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="white-box album-widget">
                            ...
                            <div class="alb-photos m-t-30">
                                <div class="alb-item">
                                    <img src="../../plugins/images/a1.jpg" alt="item">
                                </div>
                                <div class="alb-item">
                                    <img src="../../plugins/images/a2.jpg" alt="item">
                                </div>
                                <div class="alb-item">
                                    <img src="../../plugins/images/a3.jpg" alt="item">
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="temp-widget">
                            <div class="left-part" style="background-image: url('/images/cloud.jpg');">
