...
(function ($, window, document, undefined) {
  ...
  Owl.prototype.maximum = function (relative) {
    ...
    var boundary = Math.abs(this._coordinates[maximum - 1]) - this._width
    var i = -1; var j
...
;(function ($, window, document, undefined) {
    ...
    this._handlers = {
      'initialized.owl.carousel change.owl.carousel': $.proxy(function (e) {
        ...
        if ((e.property && e.property.name == 'position') || e.type == 'initialized') {
          ...
          var position = ((e.property && e.property.value) || this._core.current()) + i
  ...
  Lazy.prototype.load = function (position) {
    ...
    $elements.each($.proxy(function (index, element) {
      ...
      var url = (window.devicePixelRatio > 1 && $element.attr('data-src-retina')) || $element.attr('data-src')
...
;(function ($, window, document, undefined) {
  ...
  Video.prototype.fetch = function (target, item) {
    ...
    var id = target.attr('data-vimeo-id') || target.attr('data-youtube-id')
  ...
  Video.prototype.thumbnail = function (target, video) {
    ...
    var icon
    var path
    var dimensions = video.width && video.height ? 'style="width:' + video.width + 'px;height:' + video.height + 'px;"' : ''
