...
*/
  ...
  QUnit.assert = Assert.prototype = {
    ...
    pushResult: function (resultInfo) {
      // Destructure of resultInfo = { result, actual, expected, message, negative }
      var assert = this
      var currentTest = (assert instanceof Assert && assert.test) || QUnit.config.current
  ...
  QUnit.dump = (function () {
    ...
    var dump = {
      ...
      parse: function (obj, objType, stack) {
        stack = stack || []
        var res; var parser; var parserType
      ...
      parsers: {
        ...
        object: function (map, stack) {
          var keys; var key; var val; var i; var nonEnumerableProperties
          var ret = []
...
// Only interact with URLs via window.location
  ...
  var hasOwn = Object.prototype.hasOwnProperty
  var unfilteredUrl = setUrl({ filter: undefined,
    module: undefined,
    moduleId: undefined,
    testId: undefined })
  var defined = {
 ...
 */
  ...
  function getUrlConfigHtml () {
    var i; var j; var val
    var escaped; var escapedTooltip
    var selection = false
  ...
  function toolbarChanged () {
    var updatedUrl; var value; var tests
    var field = this
    var params = {}
  ...
  function applyUrlParams () {
    var selectedModule
    var modulesList = id('qunit-modulefilter')
  ...
  function toolbarModuleFilter () {
    ...
    var moduleFilterHtml = toolbarModuleFilterHtml()
  ...
  function appendTest (name, testId, moduleName) {
    var title; var rerunTrigger; var testBlock; var assertList
    var tests = id('qunit-tests')
  ...
  QUnit.log(function (details) {
    var assertList; var assertLi
    var message; var expected; var actual; var diff
    var showDiff = false
  ...
  QUnit.testDone(function (details) {
    var testTitle; var time; var testItem; var assertList
    var good; var bad; var testCounts; var skipped; var sourceName
    var tests = id('qunit-tests')
