...
(function (window) {
  ...
  function Sizzle (selector, context, results, seed) {
    var m; var i; var elem; var nid; var nidselect; var match; var groups; var newSelector
 ...
 */
  ...
  function getAll (context, tag) {
    var elems; var elem
    var i = 0
    var found = typeof context.getElementsByTagName !== 'undefined'
    ...
    jQuery.event.special.submit = {
      setup: function () {
        ...
        jQuery.event.add(this, 'click._submit keypress._submit', function (e) {
          ...
          var elem = e.target
          var form = jQuery.nodeName(elem, 'input') || jQuery.nodeName(elem, 'button')
 ...
 */
  ...
  (function () {
    var pixelPositionVal; var pixelMarginRightVal; var boxSizingReliableVal
    var reliableHiddenOffsetsVal; var reliableMarginRightVal; var reliableMarginLeftVal
  ...
  if (window.getComputedStyle) {
    ...
    curCSS = function (elem, name, computed) {
      var left; var rs; var rsLeft; var ret
      var style = elem.style
  ...
  function getWidthOrHeight (elem, name, extra) {
    ...
    var isBorderBox = support.boxSizing &&
  ...
  function defaultPrefilter (elem, props, opts) {
    ...
    var prop; var value; var toggle; var tween; var hooks; var oldfire; var display; var checkDisplay
    var anim = this
    var orig = {}
    var style = elem.style
