(function ($) {
  ...
  TagsInput.prototype = {
    ...
    remove: function (item, dontPushVal, options) {
      ...
      if (self.objectItems) {
        if (typeof item === 'object') { item = $.grep(self.itemsArray, function (other) { return self.options.itemValue(other) == self.options.itemValue(item) }) } else { item = $.grep(self.itemsArray, function (other) { return self.options.itemValue(other) == item }) }
