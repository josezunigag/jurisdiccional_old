(function (g) { typeof define === 'function' && define.amd ? define(['jquery', 'datatables.net', 'datatables.net-buttons'], function (i) { return g(i, window, document) }) : typeof exports === 'object' ? module.exports = function (i, j, t, u) { i || (i = window); if (!j || !j.fn.dataTable)j = require('datatables.net')(i, j).$; j.fn.dataTable.Buttons || require('datatables.net-buttons')(i, j); return g(j, i, i.document, t, u) } : g(jQuery, window, document) })(function (g, i, j, t, u, o) {
  function E (a, b) {
    v === o && (v = y.serializeToString(g.parseXML(F['xl/worksheets/sheet1.xml'])).indexOf('xmlns:r') === -1)
    g.each(b, function (b, c) {
      if (g.isPlainObject(c)) { var f = a.folder(b); E(f, c) } else {
        if (v) { var f = c.childNodes[0]; var e; var h; var l = []; for (e = f.attributes.length - 1; e >= 0; e--) { h = f.attributes[e].nodeName; var n = f.attributes[e].nodeValue; h.indexOf(':') !== -1 && (l.push({ name: h, value: n }), f.removeAttribute(h)) }e = 0; for (h = l.length; e < h; e++)n = c.createAttribute(l[e].name.replace(':', '_dt_b_namespace_token_')), n.value = l[e].value, f.setAttributeNode(n) }f = y.serializeToString(c); v && (f.indexOf('<?xml') === -1 && (f = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' +
f), f = f.replace(/_dt_b_namespace_token_/g, ':')); f = f.replace(/<row xmlns="" /g, '<row ').replace(/<cols xmlns="">/g, '<cols>'); a.file(b, f)
    ...
    var d = a.header[b].length; var c; a.footer && a.footer[b].length > d && (d = a.footer[b].length); for (var f = 0, e = a.body.length; f < e && !(c = a.body[f][b].toString().length, c > d &&
(d = c), d > 40); f++);return d > 5 ? d : 5
  } var r = g.fn.dataTable; var q; var h = typeof self !== 'undefined' && self || typeof i !== 'undefined' && i || this.content; if (typeof navigator !== 'undefined' && /MSIE [1-9]\./.test(navigator.userAgent))q = void 0; else {
    var w = h.document.createElementNS('http://www.w3.org/1999/xhtml', 'a'); var O = 'download' in w; var G = /Version\/[\d\.]+.*Safari/.test(navigator.userAgent); var z = h.webkitRequestFileSystem; var H = h.requestFileSystem || z || h.mozRequestFileSystem; var P = function (a) {
      (h.setImmediate || h.setTimeout)(function () {
        throw a
      }, 0)
    }; var A = 0; var B = function (a) { setTimeout(function () { typeof a === 'string' ? (h.URL || h.webkitURL || h).revokeObjectURL(a) : a.remove() }, 4E4) }; var C = function (a, b, d) { for (var b = [].concat(b), c = b.length; c--;) { var f = a['on' + b[c]]; if (typeof f === 'function') try { f.call(a, d || a) } catch (e) { P(e) } } }; var I = function (a) { return /^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(a.type) ? new Blob(['﻿', a], { type: a.type }) : a }; var J = function (a, b, d) {
      d || (a = I(a)); var c = this; var d = a.type; var f = !1; var e; var g; var l = function () {
        C(c, ['writestart', 'progress',
          'write', 'writeend'])
      }; var n = function () { if (g && G && typeof FileReader !== 'undefined') { var b = new FileReader(); b.onloadend = function () { var a = b.result; g.location.href = 'data:attachment/file' + a.slice(a.search(/[,;]/)); c.readyState = c.DONE; l() }; b.readAsDataURL(a); c.readyState = c.INIT } else { if (f || !e)e = (h.URL || h.webkitURL || h).createObjectURL(a); g ? g.location.href = e : h.open(e, '_blank') === o && G && (h.location.href = e); c.readyState = c.DONE; l(); B(e) } }; var m = function (a) { return function () { if (c.readyState !== c.DONE) return a.apply(this, arguments) } }
      var i = { create: !0, exclusive: !1 }; var s; c.readyState = c.INIT; b || (b = 'download'); if (O)e = (h.URL || h.webkitURL || h).createObjectURL(a), setTimeout(function () { w.href = e; w.download = b; var a = new MouseEvent('click'); w.dispatchEvent(a); l(); B(e); c.readyState = c.DONE }); else {
        h.chrome && (d && d !== 'application/octet-stream') && (s = a.slice || a.webkitSlice, a = s.call(a, 0, a.size, 'application/octet-stream'), f = !0); z && b !== 'download' && (b += '.download'); if (d === 'application/octet-stream' || z)g = h; H ? (A += a.size, H(h.TEMPORARY, A, m(function (d) {
...
a.NOT_FOUND_ERR ? e() : n()
    ...
    }; var k = J.prototype; typeof navigator !== 'undefined' && navigator.msSaveOrOpenBlob ? q = function (a, b, d) { d || (a = I(a)); return navigator.msSaveOrOpenBlob(a, b || 'download') } : (k.abort = function () { this.readyState = this.DONE; C(this, 'abort') }, k.readyState = k.INIT = 0, k.WRITING = 1, k.DONE = 2, k.error = k.onwritestart = k.onprogress = k.onwrite = k.onabort = k.onerror = k.onwriteend = null, q = function (a, b, d) { return new J(a, b, d) })
  }r.fileSave = q; var x = function (a, b) {
    var d = a.filename === '*' && a.title !== '*' &&
a.title !== o ? a.title : a.filename; typeof d === 'function' && (d = d()); d.indexOf('*') !== -1 && (d = g.trim(d.replace('*', g('title').text()))); d = d.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, ''); return b === o || !0 === b ? d + a.extension : d
  }; var Q = function (a) { var b = 'Sheet1'; a.sheetName && (b = a.sheetName.replace(/[\[\]\*\/\\\?\:]/g, '')); return b }; var R = function (a) { a = a.title; typeof a === 'function' && (a = a()); return a.indexOf('*') !== -1 ? a.replace('*', g('title').text() || 'Exported data') : a }; var K = function (a) {
    return a.newline ? a.newline : navigator.userAgent.match(/Windows/)
      ? '\r\n' : '\n'
  }; var L = function (a, b) { for (var d = K(b), c = a.buttons.exportData(b.exportOptions), f = b.fieldBoundary, e = b.fieldSeparator, g = RegExp(f, 'g'), l = b.escapeChar !== o ? b.escapeChar : '\\', h = function (a) { for (var b = '', c = 0, d = a.length; c < d; c++)c > 0 && (b += e), b += f ? f + ('' + a[c]).replace(g, l + f) + f : a[c]; return b }, i = b.header ? h(c.header) + d : '', j = b.footer && c.footer ? d + h(c.footer) : '', s = [], D = 0, k = c.body.length; D < k; D++)s.push(h(c.body[D])); return { str: i + s.join(d) + j, rows: s.length } }; var M = function () {
    return navigator.userAgent.indexOf('Safari') !== -1 &&
navigator.userAgent.indexOf('Chrome') === -1 && navigator.userAgent.indexOf('Opera') === -1
  }; try { var y = new XMLSerializer(); var v } catch (S) {} var F = { '_rels/.rels': '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/></Relationships>',
  ...
  r.ext.buttons.copyHtml5 = { className: 'buttons-copy buttons-html5',
    text: function (a) { return a.i18n('buttons.copy', 'Copy') },
    action: function (a, b, d, c) {
      var a = L(b, c); var f = a.str; var d = g('<div/>').css({ height: 1, width: 1, overflow: 'hidden', position: 'fixed', top: 0, left: 0 }); c.customize && (f = c.customize(f, c)); c = g('<textarea readonly/>').val(f).appendTo(d); if (j.queryCommandSupported('copy')) {
...
(a = c.customize(a, c)); !1 !== b ? (b || (b = j.characterSet || j.charset), b && (b = ';charset=' + b)) : b = ''; c.bom && (a = '﻿' + a); q(new Blob([a], { type: 'text/csv' + b }), x(c), !0)
    ...
    charset: null,
    header: !0,
    footer: !1 }; r.ext.buttons.excelHtml5 = { className: 'buttons-excel buttons-html5',
    available: function () { return i.FileReader !== o && (t || i.JSZip) !== o && !M() && y },
    text: function (a) { return a.i18n('buttons.excel', 'Excel') },
    action: function (a, b,
      d, c) {
      var f = 0; var a = function (a) { return g.parseXML(F[a]) }; var e = a('xl/worksheets/sheet1.xml'); var h = e.getElementsByTagName('sheetData')[0]; var a = { _rels: { '.rels': a('_rels/.rels') }, xl: { _rels: { 'workbook.xml.rels': a('xl/_rels/workbook.xml.rels') }, 'workbook.xml': a('xl/workbook.xml'), 'styles.xml': a('xl/styles.xml'), worksheets: { 'sheet1.xml': e } }, '[Content_Types].xml': a('[Content_Types].xml') }; var b = b.buttons.exportData(c.exportOptions); var l; var j; var d = function (a) {
        l = f + 1; j = p(e, 'row', { attr: { r: l } }); for (var b = 0, c = a.length; b < c; b++) {
          for (var d =
b, i = ''; d >= 0;)i = String.fromCharCode(d % 26 + 65) + i, d = Math.floor(d / 26) - 1; d = i + '' + l; if (a[b] === null || a[b] === o)a[b] = ''; typeof a[b] === 'number' || a[b].match && g.trim(a[b]).match(/^-?\d+(\.\d+)?$/) && !g.trim(a[b]).match(/^0\d+/) ? d = p(e, 'c', { attr: { t: 'n', r: d }, children: [p(e, 'v', { text: a[b] })] }) : (i = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ''), d = p(e, 'c', { attr: { t: 'inlineStr', r: d }, children: { row: p(e, 'is', { children: { row: p(e, 't', { text: i }) } }) } })); j.appendChild(d)
        }h.appendChild(j); f++
      }; g('sheets sheet',
    ...
    exportOptions: {},
    header: !0,
    footer: !1 }; r.ext.buttons.pdfHtml5 = { className: 'buttons-pdf buttons-html5',
    available: function () { return i.FileReader !== o && (u || i.pdfMake) },
    text: function (a) { return a.i18n('buttons.pdf', 'PDF') },
    action: function (a, b, d, c) {
      K(c); var a = b.buttons.exportData(c.exportOptions); var f = []; c.header && f.push(g.map(a.header, function (a) {
        return { text: typeof a === 'string' ? a : a + '',
          style: 'tableHeader' }
      })); for (var e = 0, h = a.body.length; e < h; e++)f.push(g.map(a.body[e], function (a) { return { text: typeof a === 'string' ? a : a + '', style: e % 2 ? 'tableBodyEven' : 'tableBodyOdd' } })); c.footer && a.footer && f.push(g.map(a.footer, function (a) { return { text: typeof a === 'string' ? a : a + '', style: 'tableFooter' } })); a = { pageSize: c.pageSize,
        pageOrientation: c.orientation,
        content: [{ table: { headerRows: 1, body: f }, layout: 'noBorders' }],
        styles: { tableHeader: { bold: !0, fontSize: 11, color: 'white', fillColor: '#2d4154', alignment: 'center' },
          tableBodyEven: {},
          tableBodyOdd: { fillColor: '#f3f3f3' },
          tableFooter: { bold: !0, fontSize: 11, color: 'white', fillColor: '#2d4154' },
          title: { alignment: 'center', fontSize: 15 },
          message: {} },
        defaultStyle: { fontSize: 10 } }; c.message && a.content.unshift({ text: typeof c.message === 'function' ? c.message(b, d, c) : c.message, style: 'message', margin: [0, 0, 0, 12] }); c.title && a.content.unshift({ text: R(c, !1), style: 'title', margin: [0, 0, 0, 12] }); c.customize && c.customize(a, c); b = (u || i.pdfMake).createPdf(a); c.download === 'open' && !M() ? b.open() : b.getBuffer(function (a) {
        a =
new Blob([a], { type: 'application/pdf' }); q(a, x(c))
    ...
    message: null,
    customize: null,
    download: 'download' }; return r.Buttons
})
