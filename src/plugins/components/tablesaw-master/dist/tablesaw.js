...
;(function (win, $, undefined) {
  ...
  Stack.prototype.init = function (colstart) {
    ...
    reverseHeaders.each(function () {
      ...
      var hierarchyClass = $cells.not(this).filter('thead th').length && ' tablesaw-cell-label-top'
...
;(function (win, $, undefined) {
  ...
  ColumnToggle.prototype.init = function () {
    ...
    $(this.headers).not('td').each(function () {
      var $this = $(this)
      var priority = $this.attr('data-tablesaw-priority')
      var $cells = self.$getCells(this)
  ...
  function createSwipeTable ($table) {
    ...
    function getNext () {
      ...
      $headerCellsNoPersist.each(function (i) {
        var $t = $(this)
        var isHidden = $t.css('display') === 'none' || $t.is('.tablesaw-cell-hidden')
    ...
    function fakeBreakpoints () {
      ...
      var sum = 0
      var sums = []
      var visibleNonPersistantCount = $headerCells.length

      $headerCells.each(function (index) {
        var $t = $(this)
        var isPersist = $t.is('[data-tablesaw-priority="persist"]')
...
;(function ($) {
  ...
  var methods = {
    ...
    _init: function () {
      ...
      var makeHeadsActionable = function (h, fn) {
        $.each(h, function (i, v) {
      ...
      var handleDefault = function (heads) {
      ...
      var addSwitcher = function (heads) {
    ...
    sortRows: function (rows, colNum, ascending, col) {
      ...
      var getSortFxn = function (ascending, forceNumeric) {
        var fn
        var regex = /[^\-\+\d\.]/g
        if (ascending) {
          fn = function (a, b) {
      ...
      var applyToRows = function (sorted, rows) {
        var newRows = []; var i; var l; var cur
    ...
    sortBy: function (col, ascending) {
      var el = $(this); var colNum; var rows
