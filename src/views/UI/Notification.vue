                    ...
                    <div class="white-box">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                ...
                                <!-- Start an Alert -->
                                <div class="myadmin-alert myadmin-alert-img myadmin-alert-click alert-info myadmin-alert-top alerttop2"> <img src="../../plugins/images/users/1.jpg" class="img" alt="img"><a href="#" class="closed">&times;</a>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                ...
                                <!-- Start an Alert -->
                                <div class="myadmin-alert myadmin-alert-img myadmin-alert-click alert-warning myadmin-alert-bottom alertbottom2"> <img src="../../plugins/images/users/1.jpg" class="img" alt="img"><a href="#" class="closed">&times;</a>
                                    <h4>You have a Message!</h4> <b>John Doe</b> sent you a message. <a href="#" class="closed">&times;</a> </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="white-box">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                ...
                                <!-- Start an Alert -->
                                <div id="alerttopright" class="myadmin-alert myadmin-alert-img alert-info myadmin-alert-top-right"> <img src="../../plugins/images/users/1.jpg" class="img" alt="img"><a href="#" class="closed">&times;</a>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                ...
                                <!-- Start an Alert -->
                                <div id="alerttopleft" class="myadmin-alert myadmin-alert-img alert-info myadmin-alert-top-left"> <img src="../../plugins/images/users/1.jpg" class="img" alt="img"><a href="#" class="closed">&times;</a>
                                    <h4>You have a Message!</h4> <b>John Doe</b> sent you a message.</div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                ...
                                <!-- Start an Alert -->
                                <div id="alertbottomleft" class="myadmin-alert myadmin-alert-img alert-info myadmin-alert-bottom-left"> <img src="../../plugins/images/users/1.jpg" class="img" alt="img"><a href="#" class="closed">&times;</a>
                                    <h4>You have a Message!</h4> <b>John Doe</b> sent you a message.</div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                ...
                                <!-- Start an Alert -->
                                <div id="alertbottomright" class="myadmin-alert myadmin-alert-img alert-info myadmin-alert-bottom-right"> <img src="../../plugins/images/users/1.jpg" class="img" alt="img"><a href="#" class="closed">&times;</a>
                                    <h4>You have a Message!</h4> <b>John Doe</b> sent you a message.</div>
                            </div>
                        </div>
                    </div>
