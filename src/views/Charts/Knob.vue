    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="white-box text-center">
                        <input data-plugin="knob" data-width="150" data-height="150" data-displayPrevious=true data-fgColor="#0078bc" data-skin="tron" data-cursor=true value="75" data-thickness=".2" data-angleOffset="-125" data-angleArc="250" />
                        <h6 class="text-muted m-t-10">Angle offset and arc</h6> </div>
                </div>
            </div>
            <!-- /.row -->
        ...
        <!-- /.container-fluid -->
        <footer class="footer text-center">2017 &copy; Cubic Admin</footer>
    </div>
    <!-- ===== Page-Content-End ===== -->
