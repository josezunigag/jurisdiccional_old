...
!(function ($) {
  ...
  var arrowBoth = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABMAAAATCAQAAADYWf5HAAAAkElEQVQoz7X' +
  ...
  var arrowDesc = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABMAAAATCAYAAAByUDbMAAAAZUlEQVQ4y2NgGAWj' +
  ...
  BootstrapTable.prototype.initHeader = function () {
    ...
    $.each(this.options.columns, function (i, column) {
      ...
      var style = ''
      var class_ = sprintf(' class="%s"', column['class'])
      var order = that.options.sortOrder || column.order
      var unitWidth = 'px'
  ...
  BootstrapTable.prototype.initSort = function () {
    ...
    var index = $.inArray(this.options.sortName, this.header.fields)
    ...
    if (this.options.sidePagination !== 'server') {
      ...
      this.data = s ? $.grep(this.data, function (item, i) {
        for (var key in item) {
          ...
          var value = item[key]
          var column = that.options.columns[getFieldIndex(that.options.columns, key)]
  ...
  BootstrapTable.prototype.initBody = function (fixedScroll) {
    ...
    for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
      ...
      $.each(this.header.fields, function (j, field) {
        ...
        var cellStyle = {}
        var id_ = ''
        var class_ = that.header.classes[j]
        var data_ = ''
        var rowspan_ = ''
        var column = that.options.columns[getFieldIndex(that.options.columns, field)]
    ...
    this.$body.find('> tr > td').off('click').on('click', function () {
      var $td = $(this)
      var $tr = $td.parent()
      var item = that.data[$tr.data('index')]
      var cellIndex = $td[0].cellIndex
      var $headerCell = that.$header.find('th:eq(' + cellIndex + ')')
      var field = $headerCell.data('field')
      var value = item[field]
    ...
    this.$body.find('> tr > td > .detail-icon').off('click').on('click', function () {
      ...
      var row = that.options.data[index]
    ...
    this.$selectItem.off('click').on('click', function (event) {
      ...
      var checked = $(this).prop('checked')
      var row = that.data[$(this).data('index')]
    ...
    $.each(this.header.events, function (i, events) {
      ...
      for (var key in events) {
        that.$body.find('tr').each(function () {
          var $tr = $(this)
          var $td = $tr.find(that.options.cardView ? '.card-view' : 'td').eq(i)
          ...
          $td.find(el).off(name).on(name, function (e) {
            var index = $tr.data('index')
            var row = that.data[index]
            var value = row[that.header.fields[i]]
  ...
  BootstrapTable.prototype.resetView = function (params) {
    ...
    if (this.options.height) {
      ...
      var paginationHeight = getRealHeight(this.$pagination)
  ...
  BootstrapTable.prototype.mergeCells = function (options) {
    ...
    var col = $.inArray(options.field, this.header.fields)
  ...
  $.fn.bootstrapTable = function (option) {
    ...
    this.each(function () {
      ...
      var options = $.extend({}, BootstrapTable.DEFAULTS, $this.data(),
...
(function ($) {
  ...
  var setCookie = function (that, cookieName, sValue, sPath, sDomain, bSecure) {
    ...
    var vEnd = that.options.stateSaveExpire
  ...
  var _onPageNumber = BootstrapTable.prototype.onPageNumber
  var _onPageListChange = BootstrapTable.prototype.onPageListChange
  var _onPageFirst = BootstrapTable.prototype.onPageFirst
  var _onPagePre = BootstrapTable.prototype.onPagePre
  var _onPageNext = BootstrapTable.prototype.onPageNext
  var _onPageLast = BootstrapTable.prototype.onPageLast
  ...
  BootstrapTable.prototype.initStateSave = function () {
    ...
    var sortOrderStateName = getCookie(this.options.stateSaveIdTable, idsStateSaveList.sortName)
    var pageNumberStateSave = getCookie(this.options.stateSaveIdTable, idsStateSaveList.pageNumber)
    var pageListStateSave = getCookie(this.options.stateSaveIdTable, idsStateSaveList.pageList)
    var columnsStateSave = JSON.parse(getCookie(this.options.stateSaveIdTable, idsStateSaveList.columns))
    var searchStateSave = getCookie(this.options.stateSaveIdTable, idsStateSaveList.searchText)
...
(function ($) {
  ...
  var showSortModal = function (that) {
    if (!$('#sortModal').hasClass('modal')) {
      ...
      $sortModal.off('click', '#add').on('click', '#add', function () {
        ...
        var current = $sortModal.find('tbody tr').length
      ...
      $sortModal.off('click', '.btn-primary').on('click', '.btn-primary', function () {
        var $rows = $sortModal.find('tbody > tr')
        var $alert = $sortModal.find('div.alert')
        var fields = []
        var results = []
  ...
  BootstrapTable.prototype.initToolbar = function () {
    ...
    if (this.options.showMultiSort) {
      var $btnGroup = this.$toolbar.find('>.btn-group')
      var $multiSortBtn = $btnGroup.find('div.multi-sort')
  ...
  BootstrapTable.prototype.addLevel = function (index, sortPriority) {
    ...
    var $multiSortOrder = $sortModal.find('.multi-sort-order').last()
